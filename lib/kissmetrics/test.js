...
describe('KISSmetrics', function () {
  var KISSmetrics = plugin.Integration;
  var kissmetrics;
  var analytics;
  var kissmetrics;
  var options = {
  ...
  afterEach(function(){
    analytics.restore();
    analytics.reset();
    // kissmetrics sets up timeouts
    // that cause strange problems if
    // not cleaned up.
    intervals();
    timeouts();
  });
    ...
    describe('#page', function () {
      ...
      it('should not track a named page when the option is off, but should track category', function () {
        ...
        analytics.called(window._kmq.push, ['record', 'Viewed Category Page', {
          ...
          'Viewed Category Page - url': window.location.origin + window.location.pathname,
          'Viewed Category Page - path': '/',
      ...
      it('should not track a categorized page when the option is off, but should track name', function () {
        ...
        analytics.called(window._kmq.push, ['record', 'Viewed Category Name Page', {
          ...
          'Viewed Category Name Page - url': window.location.origin + window.location.pathname,
          'Viewed Category Name Page - path': '/',
